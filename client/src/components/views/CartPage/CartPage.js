        ...
        <div className="cart-info" style={{ width: "40%" }}>
          ...
          >
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <h4>배송비 </h4>
              <h4>무료</h4>{" "}
              {/* 합계 금액에 따라서 무료인지 아닌지 ? : 이용하기*/}
            </div>
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <h2>합계</h2>
              <h2>${Total}원</h2> {/* 배송비 포함 금액 나타내기 */}
            </div>
            {ShowTotal && (
          ...
          <div className="cart-info-policy" style={{ padding: "0.5em 1em" }}>
            ...
            <div style={{ marginBottom: "1em" }}>
              <Link to="/deliverypolicy">
                <span style={{ marginRight: "1em" }}>배송정책</span>
              </Link>
              <span>
                <a href="/deliverypolicy">교환, 반품 및 환불</a>
              </span>
            </div>
            <h2>결제 방식</h2>
